...
interface TransactionOperation {
  filePath: string;
  previousContent: string | null; // null if the file did not exist
  newContent: string;
}

export class MemoryTransactionManager {
  private activeOperations = new Map<string, TransactionOperation[]>();
   ...
   */
  public async registerWrite(transactionId: string, filePath: string, newContent: string): Promise<void> {
