...
export class MemoryConflictResolver {
  private static instance = new MemoryConflictResolver();

  public static getInstance(): MemoryConflictResolver {
    return this.instance;
  }

  public resolve(localState: SessionState, remoteState: SessionState): MergeResult {
    ...
    const mergeLists = (listA: string[] = [], listB: string[] = []): string[] => {
