...
import { UnifiedPlatformEngine, EventSpecification, capabilityRegistry, GracefulDegradator, ServiceUnavailable, UnifiedConfig, unifiedMonitor, unifiedDashboardSync } from '../index.js';
describe('AEGIS Unified Intelligence Platform (AUIP) Integration Tests', () => {
    ...
    test('Unified Event Envelope generation and propagation', (t, done) => {
        mockEventBus.on('TrainingStarted', (event) => {
        ...
        const event = EventSpecification.createEvent('TrainingStarted', 'aegis-training-engine', { jobId: 'job-test-01' }, { priority: 'HIGH' });
