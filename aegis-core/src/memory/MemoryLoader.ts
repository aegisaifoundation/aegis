...
import { runtimeServices } from '../runtime/RuntimeServices.js';
...
export class MemoryLoader {
  ...
  async discoverMemoryModules(): Promise<string[]> {
  ...
  async loadMemoryModule(moduleName: string): Promise<Memory> {
    const modulesDir = this.getMemoryModulesDir();
  ...
  async initializeMemoryModule(moduleName: string): Promise<void> {
