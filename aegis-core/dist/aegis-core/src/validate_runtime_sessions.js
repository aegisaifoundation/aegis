...
import { SessionLifecycleState, BootMode, RuntimeHealthStatus } from './memory/interfaces/MemoryTypes.js';
...
async function runValidation() {
    ...
    try {
        ...
        preMutationState.runtimeMode = 'MAINTENANCE';
        ...
        assert(rolledBackState.runtimeMode === 'NORMAL', "State rolled back to checkpoint values");
