...
with open(r'c:\aegis\interfaces\terminal\scratch\title.txt', 'r', encoding='utf-8') as f:
    lines = f.readlines()
...
with open(r'c:\aegis\interfaces\terminal\scratch\formatted_art.js', 'w', encoding='utf-8') as f:
    f.write(shield_code + "\n\n" + title_code)
