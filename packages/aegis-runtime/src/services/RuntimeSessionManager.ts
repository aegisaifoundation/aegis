...
const getMemoryManager = () => serviceRegistry.get<any>('memoryManager');
...
const getMemoryWriteBuffer = () => serviceRegistry.get<any>('memoryWriteBuffer');
const getMemoryObservability = () => serviceRegistry.get<any>('MemoryObservability');
...
import { SessionLifecycleState, BootMode, RuntimeLockState, CheckoutStage, RuntimeHealthStatus, SessionState } from '@aegis/sdk';
  ...
  private startHeartbeat(): void {
    ...
    this.heartbeatInterval = setInterval(async () => {
      try {
        ...
        runtimeStateManager.saveState(state).catch((err) =>
