...
export class PeerRegistry {
    allowLoopback;
    peers = new Map();
    constructor(allowLoopback = false) {
        this.allowLoopback = allowLoopback;
    }
    setAllowLoopback(allow) {
        this.allowLoopback = allow;
    }
    registerPeer(descriptor) {
    ...
    updateConnectionState(nodeId, state) {
    ...
    resolveEndpoint(nodeId, supportedTransports) {
        const peer = this.peers.get(nodeId);
