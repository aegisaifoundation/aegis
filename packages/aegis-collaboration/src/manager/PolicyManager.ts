...
export class PolicyManager {
  private activePolicy: CollaborationPolicy;

  constructor(policyType: CollaborationPolicyType = 'personal') {
  ...
  private _buildPolicyForType(type: CollaborationPolicyType): CollaborationPolicy {
    switch (type) {
      case 'medical':
        return {
          policyType: 'medical',
