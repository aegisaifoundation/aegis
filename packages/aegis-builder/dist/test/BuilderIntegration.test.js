...
import { SourceAnalyzer, CodeCompiler, PackageBuilder, BundleBuilder, ManifestGenerator, SbomGenerator, DigitalSigner, ReleaseVerifier, GithubPublisher, BuilderCli } from '../index.js';
describe('AEGIS Builder (AEB) Integration Tests', () => {
    ...
    test('Manifest and SBOM compilation', async () => {
        ...
        const manifestPath = await manifestGenerator.generateManifest('1.0.0', '404', 'canary', checksums, bundlesSpec, testReleaseDir);
