...
export class CodeCompiler {
  ...
  async compileTypeScript(pkg: DiscoveredPackage, profile: BuildProfile): Promise<boolean> {
  ...
  async compileNativeCpp(pkg: DiscoveredPackage, profile: BuildProfile): Promise<boolean> {
