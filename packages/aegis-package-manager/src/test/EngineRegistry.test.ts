...
function createMockEnginePackage(id: string, version: string) {
...
async function runTests() {
  ...
  const entryA = registryData.engines.find((e: any) => e.id === 'engine-a');
  ...
  let disabledA = reg.engines.find((e: any) => e.id === 'engine-a');
  ...
  let enabledA = reg.engines.find((e: any) => e.id === 'engine-a');
