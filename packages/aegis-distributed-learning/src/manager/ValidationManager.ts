...
export class ValidationManager {
  private seenHashesInRounds = new Map<string, Set<string>>();

  constructor(private loraManager: LoRAManager) {}
  ...
  async validateLoRA(
    adapter: LoRAAdapter,
    roundConfig?: { roundId: string; rank?: number; alpha?: number; baseModelId?: string },
    diTrustService?: any
