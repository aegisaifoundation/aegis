...
export class LearningVersionManager {
     ...
     */
    createVersion(entityId, entityType, parentId, dataOrHash) {
    ...
    resolveParent(entityId, version) {
        const chain = this.versionStore.get(entityId) ?? [];
    ...
    recordRound(roundId, roundNumber) {
...
//# sourceMappingURL=LearningVersionManager.js.map