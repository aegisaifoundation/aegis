...
export class EngineLifecycle extends EventEmitter {
    ...
    negotiator = new ProtocolNegotiator(this.ipcManager);
    healthMonitor;
    heartbeatInterval = null;
    isLegacyMode = true; // Default to legacy mode for backward-compatibility
    executablePath = '';
    startedAt = null;
    constructor() {
        super();
    ...
    getRestartManager() { return this.restartManager; }
    getMetricsCollector() { return this.metrics; }
    getDiagnosticsManager() { return this.diagnostics; }
    getCapabilityManager() { return this.capabilities; }
    getConfigurationManager() { return this.configManager; }
    getHealthMonitor() { return this.healthMonitor; }
    getLogger() { return this.logger; }
    getSupervisor() { return this.supervisor; }
    getIpcManager() { return this.ipcManager; }
    getStartedAt() { return this.startedAt; }
    getUptimeMs() { return this.metrics.getUptimeMs(); }
    getRestartCount() { return this.restartManager.getRestartCount(); }
    async pause() { }
    async resume() { }
    setupListeners() {
        ...
        // Handle IPC packets
        this.ipcManager.on('packet', (packet) => {
    ...
    async initialize(context, executablePath) {
    ...
    startHeartbeat() {
        ...
        this.heartbeatInterval = setInterval(async () => {
            if (this.stateMachine.getState() !== EngineState.ONLINE)
                return;
            if (!this.isLegacyMode) {
                try {
                    const t0 = Date.now();
    ...
    async shutdown() {
        ...
        if (state === EngineState.STOPPED || state === EngineState.UNINITIALIZED)
            return;
...
//# sourceMappingURL=EngineLifecycle.js.map